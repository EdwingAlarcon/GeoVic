...
**`festivos_colombia.py`** — Holiday calendar. Uses the Meeus/Jones/Butcher algorithm for Easter and applies Ley Emiliani (moveable feasts shift to the next Monday). Always computes 18 holidays per year; no manual updates needed.
